    ...
    <>
        ...
        <div className="wrap">
          <RevealSection>
            <div style={{ fontFamily: "var(--mono)", fontSize: "12.5px", letterSpacing: ".18em", color: "var(--accent)", textTransform: "uppercase", marginBottom: 30, display: "flex", alignItems: "center", gap: 12 }}>
              ...
              Tech Founder &middot; Toronto, Canada
            </div>
          </RevealSection>

          <RevealSection delay={0.06}>
            <h1 style={{ fontFamily: "var(--serif)", fontWeight: 500, fontSize: "clamp(40px, 6.4vw, 76px)", lineHeight: 1.02, letterSpacing: "-.032em", maxWidth: "14ch" }}>
              Build fast. Test hard. Kill what doesn&rsquo;t work.{" "}
              <em style={{ fontStyle: "italic", color: "var(--accent)" }}>Double down</em> on what does.
            </h1>
          </RevealSection>

          <RevealSection delay={0.12}>
            <p style={{ marginTop: 30, fontSize: "clamp(17px, 2vw, 20px)", color: "var(--muted)", maxWidth: "54ch", lineHeight: 1.65 }}>
              ...
              <b style={{ color: "var(--ink)", fontWeight: 500 }}>Right now I&rsquo;m building HomeCalc.ca</b> and helping Canadian businesses get found inside ChatGPT, Perplexity, and Google AI&nbsp;Overviews.
            </p>
          </RevealSection>
        ...
        <div className="wrap">
          ...
          <RevealSection delay={0.06}>
            <div>
              ...
              <WorkItem href="/hami-tahm" dates="2012 → now" title="A decade of ventures" desc="Marketplaces, service platforms, diet & health apps, and marketing tools across two markets. Some scaled, some sunset — all sharpened the system." cta="The full story ↗" />
            </div>
          </RevealSection>
        </div>
      </section>
      ...
      <section id="writing" style={{ padding: "80px 0" }}>
        <div className="wrap">
          ...
          <RevealSection delay={0.06}>
            <div>
              <PostLink href="/what-im-actually-good-at" cat="Unicorn Building" title="What I'm Actually Good At" date="Apr 20, 2026" />
              <PostLink href="/the-longevity-economy-6-high-growth-sectors" cat="Startup & Market Analysis" title="The Six Longevity Sectors, Ranked by 2030 Market Size" date="Mar 28, 2026" />
              <PostLink href="/wine-profile" cat="Hobby" title="Understanding My Wine Taste Profile" date="Mar 7, 2026" />
            </div>
          </RevealSection>
        </div>
      </section>
          ...
          <RevealSection>
            <div>
              ...
              <p style={{ marginTop: 22, fontSize: 16, color: "var(--muted)", maxWidth: "54ch", lineHeight: 1.65 }}>
                From Shiraz to Toronto, across roughly fourteen ventures, the method never changed. The bet now is on AI-era search and a product worth scaling.
              </p>
            </div>
          </RevealSection>
          <RevealSection delay={0.06}>
...
function Stat({ value, unit, accent, label }: { value: string; unit?: string; accent?: string; label: string }) {
  return (
    <div style={{ padding: "28px 0", borderRight: "1px solid var(--line)" }}>
      <div style={{ fontFamily: "var(--serif)", fontSize: 34, fontWeight: 500, letterSpacing: "-.01em" }}>
        {value}{unit && <span style={{ color: "var(--faint)" }}>{unit}</span>}{accent && <span style={{ color: "var(--accent)" }}>{accent}</span>}
      </div>
      <div style={{ fontFamily: "var(--mono)", fontSize: "11.5px", letterSpacing: ".08em", color: "var(--muted)", textTransform: "uppercase", marginTop: 4 }}>{label}</div>
    </div>
  );
}
