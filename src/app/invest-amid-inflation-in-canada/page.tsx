    ...
    <article style={ { padding: "80px 0" } }>
      <div className="wrap" style={ { maxWidth: 720 } }>
        ...
        <div
          ...
          dangerouslySetInnerHTML={ { __html: `<p>Recently, the weakening Canadian dollar (CAD) against the US dollar (USD) has raised concerns for many investors. <a href="https://www.google.com/finance/quote/USD-CAD?sa=X&ved=2ahUKEwja8biVxp2KAxW9nokEHVGtPTkQmY0JegQIKBAu&window=1Y">As of December 10, 2024</a>, the USD/CAD exchange rate is <strong>1.4167</strong>, marking a 4.32% increase over the past year. This article explores how one might consider diversifying investments to combat inflation and currency depreciation.</p><p><em>Note: <strong>This is not financial advice—just personal curiosity and exploration.</strong></em></p><p> </p><p><img class="aligncenter" src="/images/writing/invest-amid-inflation-in-canada/CAD.png" width="400" height="268" alt="USD to CAD exchange rate chart showing a 4.32 percent increase over the past year to 1.4167 as of December 2024" />
