        ...
        <div className="wrap">
          ...
          <RevealSection delay={0.12}>
            ...
            >
              ...
              ChatGPT, Gemini, Claude, Copilot and Perplexity, then hand them a
            ...
            >
              ...
              SEO, ChatGPT SEO or LLMO: same discipline, different labels.
            </p>
          </RevealSection>
          ...
          */}
          <RevealSection delay={0.18}>
            ...
            >
              ...
              , optional, and never required to buy anything.
            </p>
          </RevealSection>
        </div>
      </header>
        ...
        <div className="wrap">
          ...
          <RevealSection delay={0.06}>
            ...
            >
              ...
              , {SNAPSHOT.engineCount}{" "}major engines returned Hami Tahm by
        ...
        <div className="wrap" style={{ maxWidth: 760 }}>
          ...
          <RevealSection delay={0.06}>
            ...
            >
              ...
              questions like these are increasingly asked of ChatGPT,
            ...
            >
              ...
              in that answer. Getting there is a different discipline (entity
              clarity, structured data, extractable content, and consistent signals
              across the web), and it&rsquo;s the whole of what I do.
            </p>
          </RevealSection>
        </div>
      </section>
            ...
            <div className="inc-grid">
              ...
              <Link href={OFFERS.monitor.href} className="inc">
                ...
                <p style={{ fontSize: 15, color: "var(--muted)", marginTop: 10, lineHeight: 1.55 }}>
                  ...
                  after the action plan, never required to start.
                </p>
                <span style={{ display: "inline-block", marginTop: 14, fontFamily: "var(--mono)", fontSize: 12, color: "var(--accent)" }}>
          ...
          <RevealSection>
            ...
            >
              <p style={{ color: "var(--ink)", lineHeight: 1.7, margin: 0, fontSize: "clamp(16px, 1.9vw, 18px)" }}>
                ...
                near-zero to {HOMECALC_CLAIMS.appearancesInTimeframe}:{" "}
        ...
        <div className="wrap">
          <RevealSection>
            <div className="local-panel">
              ...
              >
                My office is at 111 Peter Street in the Entertainment District
                (visits by appointment) and the work itself is remote-first. I
      ...
      <section style={{ padding: "60px 0" }}>
        <div className="wrap">
          ...
          <RevealSection delay={0.04}>
            ...
            >
              What can actually be measured, and what can&rsquo;t.
            </h2>
            <p
              style={{
