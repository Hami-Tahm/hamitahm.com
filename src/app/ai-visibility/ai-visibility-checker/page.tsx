...
export const metadata: Metadata = {
  ...
  description:
    "Free AI visibility checker — see how your brand shows up in ChatGPT, Google AI Overview, and Gemini for your keywords. Enter your domain and get a detailed, personalized report in under 24 hours.",
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Your detailed, personalized report lands in your inbox in under 24 hours. It covers each engine and keyword you selected for your country.",
  },
];
      ...
      <header style={{ padding: "30px 0 24px" }}>
        <div className="wrap">
          ...
          <RevealSection delay={0.06}>
            ...
            >
              See how your brand shows up when customers ask AI. Enter your
              domain and keywords, choose the engines, and get a detailed,
              personalized report — in your inbox in under 24 hours.
            </p>
          </RevealSection>
        </div>
      </header>
