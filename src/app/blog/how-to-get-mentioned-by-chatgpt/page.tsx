      ...
      <header style={{ padding: "24px 0 26px" }}>
        <div className="wrap">
          ...
          <RevealSection delay={0.18}>
            <AuthorByline date="June 8, 2026" readTime="13 min read" />
          </RevealSection>
        </div>
      </header>
        ...
        <div className="wrap">
          <RevealSection>
            <div className="final-cta">
              ...
              >
                The audit covers Google AI Overviews, ChatGPT, and Gemini, with a prioritized action plan. Scoped to your business, confirmed on a free call.
              </p>
              <Link
                href={AUDIT_URL}
